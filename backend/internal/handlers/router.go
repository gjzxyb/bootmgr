...
func NewRouter(db *gorm.DB, cfg config.Config) *gin.Engine {
	...
	protected.GET("/system/lab-validation/runs/:id", adminOnly, h.getLabValidationRun)
	protected.GET("/system/lab-validation/runs/:id/evidence-bundle", adminOnly, h.getLabValidationRunEvidenceBundle)
	protected.POST("/system/lab-validation/evidence", adminOnly, middleware.RequireConfirmation("system.lab-validation.evidence"), h.recordLabValidationEvidence)
