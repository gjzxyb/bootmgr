...
export type LabOperatorChecklistItem = { subject: string; step: string; status: 'ok' | 'warning' | 'pending' | 'error'; message: string; next_action?: string; run_id: number; server_id?: number; boot_event_id?: number; evidence_id?: number; blocking_reasons?: string[] };
